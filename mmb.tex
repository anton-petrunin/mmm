...
Applying \eqref{eq:almostall} and \eqref{eq:finally} this expression is bounded above by $4 \delta r _m^{n+1}$, for all large $m$.
Taking the inequalities together we obtain, $\epsilon \cdot r_m^ {n+1}< 4 \delta r _m^{n+1}$ for all large $m$.
...
For all small $r>0$, the neighborhood $V$ contains $B_{2r} (K)$.
