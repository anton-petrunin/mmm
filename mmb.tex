...
we deduce
\begin{align*}
\frac{\varepsilon}{2^n} &\leq \mathcal M \big(\tfrac 1 2\cdot A \big) - \mathcal M \big( \phi_1 (\tfrac 1 2\cdot A ) \big) +
\\
...
$$ \frac { \varepsilon } {2^{n+1}}  < \mathcal M \big(A _{\frac 1 2} \big) - \mathcal M \big( \phi_1 (A _{\frac 1 2}) \big).$$
...
Let $X$ be a surface with bounded integral curvature;
