...
It remains to prove the existence of $\hat X$. We take some $r>t>s$ and consider the compact metric ball $\bar B_t (x) \subset B_r (x)$.
...
From the work of Cheeger and Naber \cite{Ch-Na-codim4} it should follow that on any non-collapsed limit of manifolds with both-sided Ricci curvature bounds, the mm-curvature is locally finite and mm-boundary is zero.
