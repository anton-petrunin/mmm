...
\mathcal{V}_r = \left(1 - \frac {b_r} { \omega _n{\cdot}r^n} \right)\cdot \mu \, .
\end{equation}
...
the measures $\mathcal{V}_r /r^2$ converge in $\mathrm M(X)$ to $\frac 1 {6\cdot(n+2)}\cdot scal \cdot \mu$, where
